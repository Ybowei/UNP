...
data = dict(
    train=dict(
        ...
        support_dataset=dict(
            type='FewShotVOCDefaultDataset',
            ann_cfg=[dict(method='TFA_gncs', setting='SPLIT3_2SHOT')],
            num_novel_shots=2,
            img_prefix=data_root,
            multi_pipelines=train_multi_pipelines,
...
work_dir = '/data/huang1/PHD_Works/Few_Shot_Object_Detection/mmfewshot/work_dirs/gncs_mmfewshot_split/transfor/voc/split3/2shot_ft_cls_head'