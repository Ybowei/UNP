...
data = dict(
    train=dict(
        ...
        support_dataset=dict(
            type='FewShotVOCDefaultDataset',
            ann_cfg=[dict(method='TFA_gncs', setting='SPLIT1_1SHOT')],
            num_novel_shots=1,
            img_prefix=data_root,
            multi_pipelines=train_multi_pipelines,
...
lr_config = dict(warmup_iters=200, step=[2000, ])
...
work_dir = '/data/huang1/PHD_Works/Few_Shot_Object_Detection/mmfewshot/work_dirs/gncs_mmfewshot_split/transfor/voc/split1/1shot_ft_cls_head'