...
data = dict(
    train=dict(
        ...
        support_dataset=dict(
            type='FewShotVOCDefaultDataset',
            ann_cfg=[dict(method='TFA_gncs', setting='SPLIT1_2SHOT')],
            num_novel_shots=2,
            img_prefix=data_root,
            multi_pipelines=train_multi_pipelines,
...
lr_config = dict(warmup_iters=200, step=[4000, ])
runner = dict(max_iters=6000)
# base model needs to be initialized with following script:
#   tools/detection/misc/initialize_bbox_head.py
# please refer to configs/detection/fsce/README.md for more details.
load_from = '/data/huang1/PHD_Works/Few_Shot_Object_Detection/mmfewshot/checkpoints/gncs/transfor/voc/tfa_r101_c4_4xb2_voc_split1_base_training_random_init_bbox_head.pth'
work_dir = '/data/huang1/PHD_Works/Few_Shot_Object_Detection/mmfewshot/work_dirs/gncs_mmfewshot_split/transfor/voc/split1/2shot_ft_cls_head'