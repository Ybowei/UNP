...
data = dict(
    train=dict(
        ...
        support_dataset=dict(
            type='FewShotCocoDefaultDataset',
            ann_cfg=[dict(method='TFA_gncs', setting='10SHOT')],
            num_novel_shots=10,
            img_prefix=data_root,
            multi_pipelines=train_multi_pipelines,
...
lr_config = dict(warmup_iters=10, step=[34000])
...
work_dir = '/data/huang1/PHD_Works/Few_Shot_Object_Detection/mmfewshot/work_dirs/gncs_mmfewshot_split/transfor/coco/10shot'