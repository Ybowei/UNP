...
class FewShotCocoDefaultDataset(FewShotCocoDataset):
    ...
    coco_benchmark = {
        f'{shot}SHOT': [
            dict(
                type='ann_file',
                ann_file=f'/data/huang1/PHD_Works/Few_Shot_Object_Detection/mmfewshot/data/few_shot_ann/coco/benchmark_{shot}shot/'
